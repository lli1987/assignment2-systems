...
def benchmark_worker(
    ...
    if rank == 0:
        ...
        print()
        print("=" * 70)
        print(f"ASYNC DDP BENCHMARK  —  {model_size.upper()} model, {world_size} GPU(s)")
        print("=" * 70)
        print(
...
def main():
    ...
    parser.add_argument("--batch_size", type=int, default=4, help="Batch size per GPU (reduce if OOM)")
    parser.add_argument("--warmup_steps", type=int, default=5)
    parser.add_argument("--measure_steps", type=int, default=20)
    parser.add_argument("--use_amp", action="store_true", help="Use bfloat16 autocast (REQUIRED for large/xl models!)")
